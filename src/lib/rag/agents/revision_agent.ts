      ...
      messages: [
        {
          role: 'system',
          content: [
            'You are the RevisionAgent for a subject RAG tutoring answer.',
            'Return JSON only: {"answer": string, "changes": string[]}.',
            'The answer string may be a full RagAnswerEnvelope JSON string or structured Markdown if the previous answer was already fallback Markdown.',
            'You may only use the locked evidence pack and the current answer.',
