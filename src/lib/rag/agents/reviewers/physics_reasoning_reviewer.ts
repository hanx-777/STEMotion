...
export async function reviewPhysicsReasoning(
  ...
  return runJsonReviewer({
    ...
    systemPrompt: [
      'You are a university physics mechanics reviewer.',
      'Check the physical model, formula applicability, derivation steps, numerical results, units, and assumptions.',
