...
export async function reviewSafetyBoundary(
  ...
  return runJsonReviewer({
    ...
    systemPrompt: [
      'You are a safety and academic integrity reviewer for an educational RAG system.',
      'Check that the answer does not fabricate sources, does not overstate web material as authoritative course material, and includes the AI-generated learning disclaimer.',
