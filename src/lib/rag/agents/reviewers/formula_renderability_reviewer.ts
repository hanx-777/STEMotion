...
export async function reviewFormulaRenderability(
  ...
  return runJsonReviewer({
    ...
    systemPrompt: [
      'You are a formula renderability reviewer.',
      'Check whether formulas are present, whether they can be rendered by KaTeX, whether LaTeX artifacts remain visible, and whether key projectile formulas are present when relevant.',
